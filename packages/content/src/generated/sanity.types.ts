...
// Query: {  "siteSettings": *[_id == "siteSettings" && !(_id in path("drafts.**"))][0]{    _id,    displayName,    contactChannels[]{_key, kind, label, href}  },  "experiences": *[_type == "experience" && !(_id in path("drafts.**"))]{    _id,    employerPresentation,    employer,    confidentialClientLabel,    role,    startDate,    endDate,    current,    location,    employmentType,    employerUrl,    summary,    achievements,    "skills": skills[]->{      _id,      canonicalName,      displayName    }  }}
