...
const copy = {
  ...
  hr: {
    ...
    role: "Softverski inženjer za sustave, podatke i razvojno iskustvo.",
    intro:
      "Projektiram i gradim pouzdan softver na sjecištu pozadinskih sustava, distribuirane podatkovne infrastrukture i alata koje inženjeri svakodnevno koriste.",
    bio:
      "Moj rad pretvara složena operativna ograničenja u održive proizvode. Važne su mi jasne granice, vidljivo ponašanje i sučelja koja ljudima pomažu razumjeti što sustav radi.",
    explore: "Istraži odabrane projekte",
    getInTouch: "Započni razgovor",
    strongestEvidence: "Odabrani dokazi",
    evidence1: "Pozadinski web-sustavi",
    evidence1Text: "Produkcijske usluge oblikovane oko jasnih domenskih granica.",
    evidence2: "Distribuirani podaci",
    evidence2Text: "Pouzdani tokovi projektirani za kvar, oporavak i promjenu.",
    evidence3: "Razvojni alati",
    evidence3Text: "Alati koji skraćuju povratnu petlju bez skrivanja sustava.",
    currentFocus: "Trenutačni fokus",
    currentFocusText:
      "Praktičan razvoj uz pomoć AI-ja, otporni temelji platforme i tehničko vodstvo usmjereno na proizvod.",
    stack: "Radni skup",
    projectTitle: "Platforma za distribuirane događaje",
    projectEyebrow: "Odabrani projekt · pozadinska infrastruktura",
    projectSummary:
      "Reprezentativna studija platforme za obradu događaja koja zadržava vidljivost i mogućnost oporavka dok rastu opterećenje i broj odgovornih timova.",
    responsibility: "Uloga",
    responsibilityText: "Tehničko vodstvo · arhitektura i isporuka",
    outcome: "Ishod",
    outcomeText: "Predvidiv oporavak i jasnija operativna odgovornost",
    constraint: "Glavno ograničenje",
    constraintText: "Isporuka barem jednom bez skrivenih dvostrukih učinaka",
    architecture: "Arhitektura",
    decisions: "Tehničke odluke",
    decision1: "Idempotentnost pripada granici potrošača",
    decision1Text:
      "Svaki potrošač koji mijenja stanje bilježi stabilan ključ operacije prije potvrde rada.",
    decision2: "Ponovni pokušaji vidljivo su ponašanje proizvoda",
    decision2Text:
      "Stanje pokušaja, prijelazi u red pogrešaka i radnje operatora dijele jedan rječnik.",
    decision3: "Odgovornost prati ugovor događaja",
    decision3Text:
      "Razvoj sheme i operativna odgovornost izričite su na svakoj granici.",
    tech: "Tehnologije",
    repository: "Otvori repozitorij",
    more: "Bilješke o izvedbi",
    moreText:
      "Prototip koristi reprezentativan materijal prikladan za životopis kako bi ispitao gustoću. Završne tvrdnje i mjerenja prije objave trebaju uredničku provjeru.",
    navLabel: "Navigacija portfolija",
    page: "Prikaz",
    status: "Status",
    prototype: "Privremeni prototip",
    portrait: "Mjesto za portret",
    menu: "Izbornik",
    close: "Zatvori",
  },
};
